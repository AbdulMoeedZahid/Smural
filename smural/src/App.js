...
const OPENAI_API_KEY = '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';
      ...
      <header className="App-header">
        ...
        {token ? (
          <>
            ...
            <button className = "spotify-button" onClick={handleGenerateImage}>
              Get Top Artists and Generate Image
              </button>
          </>
        ) : (
          <button className='sp' className = "spotify-button" onClick={handleLogin}>Login to Spotify</button>
        )}
